...
const Backfire = () => {
  ...
  const benefits = [
    {
      title: "Невидимий",
      text: "Для засобів радіоелектронної розвідки він залишається непомітний завдяки відсутності постійного зв'язку та захищеній GPS антені.",
      id: useId(),
    },
    {
      title: "Автономний",
    ...
    },
    {
      ...
      text: "Корисне навантаження до 4 кг вибухівки",
      id: useId(),
    },
    {
      title: "Витривалий",
